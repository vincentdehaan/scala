...
trait Flags {
  ...
  def flags: Map[String, Boolean] = Map(
    "implicit" -> isImplicit,
    "final" -> isFinal,
    "private" -> isPrivate,
    ...
    "contravariant" -> isContravariant,
    "label" -> isLabel,
    "in contructor" -> isInConstructor,
    "abstract override" -> isAbstractOverride,
    "local" -> isLocal,
    "java" -> isJava,
    "synthetic" -> isSynthetic,
    "stable" -> isStable,
    "static" -> isStatic,
    "case accessor" -> isCaseAccessor,
    "trait" -> isTrait,
    "bridge" -> isBridge,
    "accessor" -> isAccessor,
    "super accessor" -> isSuperAccessor,
    "param accessor" -> isParamAccessor,
    "module var" -> isModuleVar,
    "monomorphic" -> isMonomorphic,
    "lazy" -> isLazy,
    "error" -> isError,
    ...
    "expanded name" -> isExpandedName,
    "implementation class" -> isImplementationClass,
    "pre super" -> isPreSuper
  )
}